...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/planB/css/",
        js: project_folder +"/local/templates/planB/js/",
        img: project_folder +"/local/templates/planB/img/",
        image: project_folder +"/local/templates/planB/image/",
        fonts: project_folder +"/local/templates/planB/fonts/",
        video: project_folder +"/local/templates/planB/video/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/planB/scss/style.scss",
        js: source_folder +"/local/templates/planB/js/script.js",
        img: source_folder +"/local/templates/planB/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/planB/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/planB/fonts/**/*.{eot,ttf,woff,woff2,svg}",
        video: source_folder + "/local/templates/planB/video/**/*.{mp4,ogv,webm}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/local/templates/planB/scss/**/*.scss",
        js: source_folder +"/local/templates/planB/js/**/*.js",
        img: source_folder +"/local/templates/planB/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/planB/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/planB/fonts/**/*.{eot,ttf,woff,woff2,svg}",
        video: source_folder + "/local/templates/planB/video/**/*.{mp4,ogv,webm}"
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/planB/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/planB/img/'))
});
